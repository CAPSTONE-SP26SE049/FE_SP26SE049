...
export default function PronunciationModelPage() {
    ...
    const displayViseme = isPlaying ? currentViseme : activeSound.toLowerCase();
                            ...
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    <div className="bg-red-50 rounded-xl border-[1.5px] border-slate-900 p-4 space-y-1.5">
                                        ...
                                        <p className="text-red-700 font-bold text-xs leading-relaxed pl-6">{SOUND_INFO[activeSound].regionError}</p>
                                    </div>
                                </motion.div>
                            </AnimatePresence>
