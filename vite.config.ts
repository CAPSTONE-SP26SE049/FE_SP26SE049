...
export default defineConfig(({ mode }) => {
    ...
    const proxyTarget = isLocalDev ? 'https://speakvn-backend-670338943429.asia-southeast1.run.app' : env.VITE_API_URL?.replace('/api/v1', '') ?? 'https://speakvn-backend-670338943429.asia-southeast1.run.app'
